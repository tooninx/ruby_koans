...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # it will only fail if it is associated with other patterns that
    # doesn't much.
    #
    # examples: "abbcccddddeeeee"[/z* ./], "abbcccddddeeeee"[/nz*/]
  end
  ...
  # Why?
  # =======================================================
  # they much as many occurences as possible
  ...
  def test_scan_is_like_find_all
    ...
    assert_equal [["on", "e"], ["thr", "ee"]], "one two-three".scan(/([ot]\w+?)(e+)/)
  end
